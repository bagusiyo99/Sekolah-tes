...
import com.sekolah.services.jwt.JwtRequestFilter;
import com.sekolah.until.JwtUtil;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http.csrf().disable()
                ...
                .requestMatchers( "/company/sign-up", "/client/sign-up", "/ads", "/search/{service}").permitAll()
                ...
                .requestMatchers(HttpMethod.DELETE, "/api/client/booking/{bookingId}").permitAll()
                ...
                .requestMatchers(HttpMethod.GET, "/api/company/bookings/grouped/{companyId}").permitAll()
                ...
                .requestMatchers(HttpMethod.GET, "/api/company/cari").permitAll()

                .requestMatchers(HttpMethod.GET, "/api/client/articles/**").permitAll()

                // Mengizinkan akses POST ke endpoint tertentu tanpa otentikasi
                .requestMatchers(HttpMethod.POST, "/api/company/teacher/**").permitAll()
                // Mengizinkan akses GET ke endpoint tertentu tanpa otentikasi
                .requestMatchers(HttpMethod.GET, "/api/company/teachers/**").permitAll()
                // Mengizinkan akses PUT ke endpoint tertentu tanpa otentikasi
                .requestMatchers(HttpMethod.PUT, "/api/company/teacher/**").permitAll()
                // Mengizinkan akses GET ke endpoint tertentu tanpa otentikasi
                .requestMatchers(HttpMethod.GET, "/api/company/teacher/**").permitAll()
                // Mengizinkan akses DELETE ke endpoint tertentu tanpa otentikasi
                .requestMatchers(HttpMethod.DELETE, "/api/company/teacher/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/company/pencarian").permitAll()

                .requestMatchers(HttpMethod.GET, "/api/client/teachers/**").permitAll()
